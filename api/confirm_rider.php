<?php
    ...
    $insertQuery = "INSERT INTO rides (passenger, driver, location, destination, user_contact, amount, status) 
                    VALUES (:passenger, :driver, :location, :destination, :contact,  :amount, :status)";
